...
var DonorComponent = (function () {
    function DonorComponent(donorService) {
    ...
    ;
    DonorComponent.prototype.getDonors = function () {
    };
    DonorComponent.prototype.openModal = function (id) {
        var st = '#' + id;
        document.getElementById("modalPopup").innerHTML = document.getElementById(id).innerHTML;
        showModal();
    };
    DonorComponent.prototype.getDonorDetail = function (record) {
    };
    ;
